...
const detect = (message: string = "You are using Android Stock-Browser. To access our web app, you need to download Google Chrome. Click OK and you'll be redirected for download.") => {
  if (isStock) {
    alert(message)
